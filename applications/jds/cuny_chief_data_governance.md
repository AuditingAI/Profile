# Chief Data and Governance Strategist (University Dean) — CUNY

- **Employer:** The City University of New York
- **Location:** New York, NY
- **Source:** LinkedIn job alert, 2026-07-25
- **Posting:** https://www.linkedin.com/jobs/view/4444071650/
- **Job ID:** 4444071650

## Why this role ranks at the top

Merges both search streams into one position:

- **Data governance leadership** — the core of 20+ years of work at Citi and JPMorgan.
- **University employer** — H-1B cap-exempt, which matters for the sponsorship objective. Confirm specifics with immigration counsel; do not rely on this note.
- **Dean-level title** — executive standing, and a credential that strengthens both the DBA and any later faculty track.
- **Public mission, NYC-local** — no relocation.
...
- No higher-education administration experience; no FERPA administration.
- Unfamiliar with CUNY shared-governance culture, faculty senate norms, enrollment reporting.
- "University Dean" is an administrative title here, not a faculty appointment — confirm whether any faculty rank or teaching expectation attaches.

## Before submitting — verify against the live posting
...
Tailor the summary line and the first cover-letter paragraph once the real requirements are known.
