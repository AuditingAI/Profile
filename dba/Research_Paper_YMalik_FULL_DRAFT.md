...
> **WORKING DRAFT — full assembly for advisor review.** Chapters 1, 4, 5, and 6 revised per the late-July advisor meeting; Chapters 2–3 and Appendix A stand as previously approved. Reference list appears in two parts pending final merge.
...
*(Figure 1 — the research model. Image file: `Anchoring_Bias_Research_Model.png`; embedded as a rendered figure in the Word/Canvas submission.)*
...
# REFERENCES — PART II (CHAPTERS 1 AND 4–6; pending merge into Part I)
