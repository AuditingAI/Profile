...
**Stage 4a — Finalize the manuscript.** No update to argument, hypotheses, or model. The methodology section will be updated next week to incorporate the data-quality control specification (attention/focus screen + page timers + open-ended substantive check), with the three new citations added to the verified reference pool.
...
**Boundaries held.** No AI/LLM items in this survey (reserved for a future research extension only). No employer / client / account-level / sensitive personal data requested at any point. Wording-and-flow-only revisions during the informal preview and formal pilot; any scope-affecting change halts and escalates to advisor + IRB review before application.
