...
- **Factor-retention decision.** Convergence of three criteria: eigenvalues greater than 1 (Kaiser, 1974) as a screen, inspection of the scree plot's elbow, and — as the deciding criterion where they disagree — parallel analysis against random-data eigenvalues. The theoretical expectation is eleven factors; the data are permitted to disagree.
