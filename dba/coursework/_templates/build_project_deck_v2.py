...
try:
    ...
    _p="/home/user/Profile/dba/coursework/GEB7365_International_Business/figures/h2_timeline.png"
    iw,ih=_I.open(_p).size
    w=W-2*M; h=w*ih/iw
    if h>238: h=238; w=h*iw/ih
    c.drawImage(_p,(W-w)/2,y(190+h),width=w,height=h,mask='auto',preserveAspectRatio=True)
    bot=190+h
except Exception:
    box(M,190,W-2*M,252,fill=PALE,stroke=RULE,r=4); bot=442
...
txt("~20",M+72,362,DISP,26,BLUE); txt("eligible",M+134,370,BODY,12.5,BODYC)
arrow(M+18,410,M+58,410,color=BLUE,lw=1.6)
txt("4",M+72,396,DISP,26,RUST); txt("usable, of 23 raw starts",M+96,404,BODY,12.5,BODYC)
