...
4. **Decide: refund vs. credit.** Options once released:
   ...
   - Recommendation: **keep as credit** if the dissertation continues on Prolific with a broadened population; refund if cash matters now.
5. **Message Prolific support** (Help Centre → contact) — one short note: study targeted US auditors, filled 2/100 in 13 days; ask (a) what prevalence their pool shows for audit professionals, and (b) whether Managed Services or custom screening could realistically fill a broadened professional sample for a future study. Their answer is free market research for the dissertation sampling plan.
6. **Enable MFA** on the account (the banner warning) — the account holds real money.

## For the dissertation relaunch (later, post-IRB amendment)
- Broaden screeners: accountants/finance professionals with audit-adjacent judgment tasks (matches Ch. 6.2 recommendation #3) → prevalence rises by an order of magnitude.
- Consider Prolific's representative/custom samples or CloudResearch Connect professional panels in parallel.
- Budget planning: at realistic professional-sample rates, the recovered ~$980 funds roughly 100–150 completions of a shorter (10–12 min) instrument.
