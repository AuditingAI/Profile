    ...
    ("DAY +1 — THE FOCUSED BUILD DAY", "Saturday, June 20, 2026", colors.HexColor("#b8650a"), [
        ...
        ("4 hr",    "1 PM – 5 PM — Build Qualtrics survey",
            ["Create project: \"Auditors' Professional Judgments and Audit Work Practices\"",
             ...
             "Block 3 — INITIAL QUALITY SCREEN (Q-A1 commitment + Q-A2 early IMC + Q-A3 audit-context)",
             "Blocks 4–14 — 11 construct blocks × 5 items each (5-point Likert), inside Randomizer",
             "Mark reverse-coded item per block",
             "Embed Q-B1 IMC after 4th randomized block (\"select Agree\")",
             "Embed Q-B2 IMC after 8th randomized block (\"select Disagree\")",
             "Enable hidden page timers on every construct block",
             "Block 15 — Final quality check (Q-C1 open-text audit example)",
             "Block 16 — Demographics (experience, role, firm, industry, credential, region)",
