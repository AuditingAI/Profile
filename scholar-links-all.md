...
- Total unique papers: **279**
- Date range: **September 2025 – May 2026**
- Note: For the most recent ~16 alert emails, all ~10 papers per email were extracted. For older alerts, the most prominent/top paper from each email is shown (one per alert). All entries link to the direct paper URL where available; otherwise to a Google Scholar search link.
...
- **[Enhancing System Robustness through Adversarial Reinforcement Learning and Large Language Model Reasoning for Automated Vulnerability Assessment in Complex Decision Environments](https://www.isipress.org/index.php/IJAIR/article/download/149/206)** — D Ashcroft - International Journal of Artificial Intelligence Research, 2026
